...
- (NSArray *)mas_makeConstraints:(void(^)(MASConstraintMaker *))block __attribute__((warn_unused_result)) {
...
- (NSArray *)mas_updateConstraints:(void(^)(MASConstraintMaker *))block __attribute__((warn_unused_result)) {
    self.translatesAutoresizingMaskIntoConstraints = NO;
    MASConstraintMaker *constraintMaker = [[MASConstraintMaker alloc] initWithView:self];
...
- (NSArray *)mas_remakeConstraints:(void(^)(MASConstraintMaker *make))block __attribute__((warn_unused_result)) {
    self.translatesAutoresizingMaskIntoConstraints = NO;
    MASConstraintMaker *constraintMaker = [[MASConstraintMaker alloc] initWithView:self];
